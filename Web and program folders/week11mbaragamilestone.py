...
#             line = line.strip()
#             parts = line.split(",")
#             country_name = parts[0, 'intity']
#             country_code = parts[1, 'code']
#             year_analysing = parts[2, 'year']
#             life_expectancy = parts[3, 'life expectancy']
###################
# #interested_year = int(input('Enter the year that your are interested in to analyse: '))
# max_life_expenctancy = 1
...
#       parts = line.split(",")
      ###################################33
#       intity = parts[0].strip()
#       code = parts[1].strip()
#       year = parts[2].strip()
#       life_expectancy = (parts[3])
#       if life_expectancy == max_life_expenctancy:
#        print(f' the year with maximum life expectancy is: {max_life_expenctancy}')
